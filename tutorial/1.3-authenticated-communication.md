...
To mitigate against this sort of data breach, the Noise Protocol provides a mechanism, known as "key ratcheting", to achieve **forward secrecy**, whereby the encryption keys change roughly every 1,000 messages. Once the new key is derived, the old key is discarded and cannot be recovered.
