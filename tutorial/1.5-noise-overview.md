# Noise Protocol Overview - A Flexible Framework
...
To define the specific Noise Protocol that is being used, you simply concatenate your implementation's choice of handshake pattern, Diffie-Hellman function, cipher function, and hash function - all separated by an underscore. Below is the variant of the Noise protocol that Lightning uses.
